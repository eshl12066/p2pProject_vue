<template>
  ...
  <div id="app">
    <el-form label-width="100px">
      <el-form-item style="background-color: rgb(195, 202, 215);" label="会员房贷">
      </el-form-item>
      <el-row>
        <el-col :span="4">
			<span>
    ...
    <el-dialog title="通过备注" :visible.sync="dialogFormVisible3"  append-to-body="false">
      <el-form :model="form3" size="mini">
        <el-row>
          <el-col >
            <el-form-item  label="描述" :label-width="formLabelWidth3">
              <el-input style="width: 75%;"  v-model="form3.description" type="textarea"
                        rows="4"
                        readonly="readonly"></el-input>
            </el-form-item>
          </el-col>
...
<script >
  export default {//0 审核中，3 满标查 ，1 审核失败 ，7 审核成功
    ...
    created(){
      ...
      this.axios.post(url,{"bidRequestType":2}).then((response)=>{
    ...
    methods:{
      ...
      yesDiag3(row){
        ...
        this.form3.description = row.description;
