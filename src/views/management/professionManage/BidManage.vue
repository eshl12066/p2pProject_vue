    ...
    <div align="center">
      <el-main>
        ...
        <el-table :data="tableData" border style="width: 100%">
          <el-table-column prop="bid_request_amount" label="投资总额" width="119" align="center" sortable></el-table-column>
          <el-table-column prop="current_rate" label="利息率" width="119" align="center" sortable></el-table-column>
          <el-table-column prop="monthes_return" label="还款月数" width="119" align="center" sortable></el-table-column>
          <el-table-column prop="return_type" label="还款方式" width="119" align="center"></el-table-column>
          <el-table-column prop="bid_request_type" label="贷款类型" width="119" align="center"></el-table-column>
          <el-table-column prop="current_sum" label="现有投资" width="119" align="center" sortable></el-table-column>
          <el-table-column prop="disable_date" label="投标截止时间" width="189" align="center" sortable ></el-table-column>
...
<script>
  export default {
    ...
    created(){//投标数据展示
      debugger
      alert("created,投标数据展示")
      let url = this.axios.urls.SYSTEM_BID_BIDQUERY;
      alert("created里面，url:"+url);
