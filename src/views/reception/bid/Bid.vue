  ...
  <div style="background-color: white;">
    ...
    <el-main>
      ...
      <el-button-group>
        ...
        <el-button type="primary" round>招标中</el-button>
      </el-button-group>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="title" label="借款标题" width="118" align="center"></el-table-column>
          ...
          <template slot-scope="scope">
            ...
            <el-popover placement="right" width="666" trigger="click">
              <el-card class="box-card" style="background-color: whitesmoke;"><br/>
                <!--  头 部  -->
                <div slot="header" class="clearfix">9*
                  &nbsp;借款标题：XXX<br/><br/>
